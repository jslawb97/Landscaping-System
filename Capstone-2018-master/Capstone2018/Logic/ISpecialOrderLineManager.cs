...
namespace Logic
{
    public interface ISpecialOrderLineManager
    {
        /// <summary>
        /// Reuben Cassell
        /// Created 2/23/2018
        ...
        /// <returns></returns>
        bool EditSpecialOrderLineQtyReceivedByID(int id, int oldRecieved, int newRecieved);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        bool EditSpecialOrderLineQtyReceivedToQtyOrderedByOrderID(int id);
    }
}
